<%-- 
    Document   : updatePublicUserProceed
    Created on : Nov 2, 2021, 11:15:32 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Update Public User Page</title>
    </head>
    <body>
        <jsp:include page="updatePublicUserPage.jsp"/>
        <div class="container">
            <form action="UpdatePublicUserProceed" method="POST">
                <div class="row">
                        ...
                        <div class="p-3 py-1">
                            ...
                            <c:forEach items="${result.rows}" var="row">
                                <div class="row gap-1">
                                    ...
                                    <div class="col-md-8"> 
                                        <input type="text" name="vaccinationStatus" class="form-control" value="${row.vaccinationStatus}" readonly>
                                    </div>
                                </div>
                            </c:forEach>
