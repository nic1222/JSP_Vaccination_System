 ...
 * @author user
 */
@WebServlet(name = "EditPublicUserAccProceed", urlPatterns = {"/EditPublicUserAccProceed"})
public class EditPublicUserAccProceed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PublicUser toEditUser = (PublicUser) s.getAttribute("login");
