 ...
 * @author user
 */
@WebServlet(name = "UpdatePublicUserProceed", urlPatterns = {"/UpdatePublicUserProceed"})
public class UpdatePublicUserProceed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (username != null && password != null && phone != null && email != null && address != null) {
            PublicUser toEditUser = publicUserFacade.find(username);
