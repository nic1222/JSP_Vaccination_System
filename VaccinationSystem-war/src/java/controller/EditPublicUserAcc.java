 ...
 * @author user
 */
@WebServlet(name = "EditPublicUserAcc", urlPatterns = {"/EditPublicUserAcc"})
public class EditPublicUserAcc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PublicUser currentUser = (PublicUser) s.getAttribute("login");
        ...
        request.setAttribute("vaccinationStatus", currentUser.getVaccinationStatus());
        
        request.getRequestDispatcher("editPublicUserAcc.jsp").include(request, response);
    }
