 ...
 * @author user
 */
@WebServlet(name = "VaccinationPublicUser", urlPatterns = {"/VaccinationPublicUser"})
public class VaccinationPublicUser extends HttpServlet {
