    <%-- 
    Document   : updateMinistryProceed
    Created on : Nov 1, 2021, 10:11:07 PM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>Update Ministry Page</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">   
    </head>
    <body>
        <jsp:include page="updateMinistryPage.jsp"/>
        <div class="container">
            <form action="UpdateMinistryProceed" method="POST">
                <div class="row">
                        ...
                        <div class="p-3 py-1">
                            ...
                            <c:forEach items="${result.rows}" var="row">
                                <div class="row gap-1">
                                    ...
                                    <div class="col-md-8"> 
                                        <input type="text" name="ic" class="form-control" value="${row.ic}" pattern="\d*" maxlength="12" placeholder="Number Only" required>
                                    </div>
                                    <div class="col-md-3">
