<%-- 
    Document   : editClinicAcc
    Created on : Oct 30, 2021, 4:26:08 PM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <title>My Clinic Account</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">   
    </head>
    <body>
        <jsp:include page="bannerClinic.jsp"/>
        <div class="container">
            <form action="EditClinicAccProceed">
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div class="p-3 py-5">
                            <div class="d-flex align-items-center mb-3">
                                <h4 class="text-right">My Clinic Account</h4>
                            </div>
                            <div class="row gap-1">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-8"> 
                                    <input type="text" name="clinicId" class="form-control" placeholder="enter clinic id" value="${clinicId}" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label class="labels">Clinic Name</label>
                                </div>
                                <div class="col-md-8"> 
                                    <input type="text" name="clinicName" class="form-control" placeholder="enter clinic name" value="${clinicName}" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="labels">Clinic Address</label>
                                </div>
                                <div class="col-md-8"> 
                                    <input type="text" name="clinicAddress" class="form-control" placeholder="enter address" value="${clinicAddress}" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="labels">State/Federal Territory</label>
                                </div>
                                <div class="col-md-8"> 
                                    <input type="text" name="state" class="form-control" placeholder="name" value="${state}" required>
                                </div>
                                <div class="col-md-3">
