<%-- 
    Document   : updatePublicUserPage
    Created on : Nov 2, 2021, 11:15:12 AM
    Author     : user
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <form action="updatePublicUserProceed.jsp" method="POST">
                <div class="row">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div class="p-3 py-5">
                            <div class="d-flex align-items-center mb-3">
                                <h4 class="text-right">Edit Public User Account</h4>
                            </div>
                            <div class="row gap-1">
                                <div class="col-md-3">
